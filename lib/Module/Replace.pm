...
Monkey patching.  Rather than modifying another package's code directly,
you replace it at runtime.  This is always a bit dangerous, but upgrading
that package won't directly lose your changes.  Your changes may not work
anymore, but since they will be in your code, that upgrade won't have removed
them.
